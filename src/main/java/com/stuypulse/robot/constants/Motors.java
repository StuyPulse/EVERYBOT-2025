...
//         public final NeutralModeValue NEUTRAL_MODE;
...
//         public TalonSRXConfig(boolean inverted, NeutralModeValue neutralMode, int peakCurrentLimitAmps) {
//             this(inverted, neutralMode, peakCurrentLimitAmps, 0.0);
//         }

//         public TalonSRXConfig(boolean inverted, NeutralModeValue neutralMode) {
...
//         public VictorSPXConfig(boolean inverted, NeutralModeValue neutralMode) {
