...
public interface Settings {
    ...
    public interface Pivot { // TODO Change max pivot speed to whatever ryan/bennett tells us because so far belt can only handle 0.75 but they said to start at 1 and test
